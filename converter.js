...
convert.addEventListener("click", () => {
  ...
  if (from.value == "Decimal" && to.value == "Decimal") {
    ...
    let ans1 = convertDecimalToBinary(input.value);
    ...
    let ans3 = convertDecimalToHexadecimal(input.value);
    ...
    let ans7 = convertDecimalToOctal(input.value);
...
function convertBinaryToHexadecimal(inputNumber) {
  ...
  const answer = convertDecimalToHexadecimal(decimalVal1);
  return answer;
}
...
function convertBinaryToOctal(inputNumber) {
  ...
  const answer = convertDecimalToOctal(decimalVal3);
...
function convertOctalToBinary(inputNumber) {
  ...
  const answer = convertDecimalToBinary(decimalVal5);
  return answer;
}
...
function convertHexadecimalToOctal(inputNumber) {
  ...
  const answer = convertDecimalToOctal(decimalVal4);
  return answer;
}
...
function convertHexadecimalToBinary(inputNumber) {
  ...
  const answer = convertDecimalToBinary(decimalVal2);
  return answer;
}
...
function convertOctalToHexadecimal(inputNumber) {
  ...
  const answer = convertDecimalToHexadecimal(decimalVal6);
  return answer;
}